...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Transcript-to-exact-SCO/topological reduction | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Exact convex-reduction, global convex-fiber, and distribution-independent exactification interfaces have no supported producer; retry mode new_idea |
