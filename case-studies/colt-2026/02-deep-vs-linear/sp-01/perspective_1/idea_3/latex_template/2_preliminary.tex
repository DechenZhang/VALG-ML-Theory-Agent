...
because it is simultaneously the norm defining the static ball \eqref{eq:p1-i3-eq007} and the
norm in the gradient envelope \eqref{eq:p1-i3-eq009}.  For a distribution $\mathcal D$ on the
...
$d_{\rm path}$ retain the definitions \eqref{eq:p1-i3-eq011}--\eqref{eq:p1-i3-eq012}, which are the public feature
