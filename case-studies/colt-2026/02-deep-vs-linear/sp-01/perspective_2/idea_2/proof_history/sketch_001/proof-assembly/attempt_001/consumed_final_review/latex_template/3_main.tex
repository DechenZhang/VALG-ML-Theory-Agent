...
This result is conditional on the target-independent confident-map premise.
...
$d=0$, Theorem~\ref{thm:main} itself forces exact dimension zero; if
$p(S,T)=d$, the bridge is equality.
\end{proof}
