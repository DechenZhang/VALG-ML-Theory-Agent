...
\tag{12}\label{eq:p1-i3-eq012}
\]
where the empty product is one for $L=1$.  Let
$\mathcal P_{\rm gate}$ be the pushforward law of
$\varphi_{\theta^{(0)}}$ under the Gaussian initialization \eqref{eq:p1-i3-eq003}.  This law is
