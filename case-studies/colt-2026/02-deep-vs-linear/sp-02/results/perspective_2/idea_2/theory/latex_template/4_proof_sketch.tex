...
simplex \(\Delta(S)\).  Sion's theorem
\citep[Theorem~3.4]{sion1958minimax} changes the order of optimization, while
the exact-center witness may vary with \(p\) inside the same fixed body.
