...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Point-mass robust separation, tolerance-energy quotient, arbitrary-domain exactification | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Finite Gordan separation is valid, but no branch-uniform common-rank/common-kernel source or arbitrary-domain exactification bridge exists under the unchanged theorem contract. |
