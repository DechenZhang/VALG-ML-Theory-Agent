...
- Internal label/ref structure: PASS. The bundle has 33 unique labels, all 27 referenced labels resolve, both external citation keys resolve to `reference.bib`, both invocations of Sion's theorem cite Theorem 3.4 explicitly, theorem dependencies name their result types, and no malformed reference or citation command was found.
