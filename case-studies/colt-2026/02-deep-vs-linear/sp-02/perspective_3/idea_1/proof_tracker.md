...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Overlap coupling, strict pivot growth, branch-uniform energy, exact sign extraction | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | The exposed rate fails on singleton boundary regimes, exact annihilating-probability separation is false on an allowed countable domain, and no branch-uniform energy source closes the route. |
