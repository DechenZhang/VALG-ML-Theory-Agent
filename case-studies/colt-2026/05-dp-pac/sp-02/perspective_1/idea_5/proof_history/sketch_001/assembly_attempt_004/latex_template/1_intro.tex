...
concept class.  Write \(L_\kappa=\log|C_\kappa|\) and use the
corresponding subscripts on \(d,\ell,s,q\).  The target is the following
conditional statement.  Every such domain-and-class sequence satisfying
\[
