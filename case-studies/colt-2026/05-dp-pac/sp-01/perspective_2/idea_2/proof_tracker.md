...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | RSC-to-Lyu stage compatibility and one-power privacy-scheduling amortization | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Primary-source review found that RSC requires already-private computations, conflicts with Lyu's fixed-block utility reuse, and targets a stage-composition factor already removed by sparse vector; the d^5 source count has no scheduler-removable d factor. |
