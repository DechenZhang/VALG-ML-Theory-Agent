...
- Accepted dependency proof/review SHA-256 pairs:
  ...
  - step_011 (producer Unit attempt 2; accepting review binds Unit attempt 2
    at Review attempt 2):
  ...
  - step_013 (producer Unit attempt 3; accepting review binds Unit attempt 3
    at Review attempt 4):
...
- Prior same-step proof/review SHA-256, supplied by the controller for
  provenance only:
  ...
  The stale review was not read or used as proof evidence.

Every listed dependency review has status ACCEPTED and matches the listed
proof artifact and producer Unit attempt. The current accepting Step 011
review certifies its three accepted direct dependency pairs. The current
accepting Step 013 review certifies its five accepted direct dependency
pairs and its recorded full ancestor closure; across that closure, the
Step 001, Step 002, and Step 007 identities agree exactly with the live
direct pairs bound above. No ancestor is promoted to a direct Step 014
dependency. Every later reference to accepted Step 011 or Step 013 means
exactly producer Unit attempt 2 or 3, respectively.
