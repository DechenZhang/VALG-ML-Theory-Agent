...
\tag{2}
\]
Define the endpoint-complete current restrictions and structural parameters by
\[
...
inequality and the Bernoulli lower tail give (C6)--(C7).
