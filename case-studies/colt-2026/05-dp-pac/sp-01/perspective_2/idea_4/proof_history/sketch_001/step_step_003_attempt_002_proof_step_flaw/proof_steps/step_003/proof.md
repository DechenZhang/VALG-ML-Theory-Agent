...
| Proposition~\ref{prop:step-003-quotient-kernel} | Any pointwise \(H_C\)-law supplied by a totalized procedure; accepted Proposition~\ref{prop:step-001-zero} for the exact \(d=0,N=0\) law | Quotient Markov kernel \(K_N\), including the exact null law | Lemma~\ref{lem:step-003-countable-promotion}, accepted Proposition~\ref{prop:step-001-totalization} on the positive branch, and accepted Proposition~\ref{prop:step-001-zero} on the null branch; used by Proposition~\ref{prop:step-003-raw-pullback}. |
...
When \(d=0\), the accepted dependency explicitly named in this proposition,
...
the exact \(d=0,N=0\) Dirac law at the unique \(\bar c_0\). Accepted
...
the \(d=0,N=0\) Dirac law supplied through accepted
Proposition~\ref{prop:step-001-zero} and every arbitrary-label input
included. Finally, accepted Proposition~\ref{prop:step-002-record-map} and
