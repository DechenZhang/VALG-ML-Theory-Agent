...
\]
for the universal constants used below.  No fixed positive
$\delta$ is silently absorbed into that source-facing comparison.
\end{assumption}

\subsection{Formalized Goal}
This result is explicitly conditional on the four assumptions above.  It
...
quotient is part of the stated scope; classes with uncountably many
