...
be the totalized quotient-first law specified in the preliminaries, and let
\[
...
$d\ge1$, there is a universal constant $K_{\mathrm V}\ge1$ such that
...
On the same quotient interface, the totalized old-Lyu~\citep{lyu2025} law has a measurable
...
\]
for a universal $K_{\mathrm O}\ge1$.  When $|C|<\infty$, the finite
...
Under these assumptions, specialize the auxiliary teacher and block
