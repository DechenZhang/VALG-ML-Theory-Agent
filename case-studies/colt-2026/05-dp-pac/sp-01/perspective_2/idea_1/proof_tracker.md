...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Universal dyadic SOA chain-or-rank-drop certificate and private aggregation | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Infinite VC-one, LD-one point functions falsify the required finite rank-drop/single-cut certificate; repair requires a new procedure or mechanism source. |
