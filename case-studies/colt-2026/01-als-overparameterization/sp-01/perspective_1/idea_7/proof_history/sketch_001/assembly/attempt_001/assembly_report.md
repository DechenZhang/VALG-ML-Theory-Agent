...
The appendix contains one subsection for each step, 55 translated public
lemma/proposition blocks, and the full local-derivation and target-assembly
mathematical content.  The static event bridge is stated as
...
- Internal labels: 83 unique labels in the bundle; all `ref`/`pageref` targets resolve.
- External citations: `Uschmajew2012` is cited with a matching BibTeX entry.
- Appendix source-length diagnostic: 4,327 source lines under local derivation/target assembly versus 4,795 appendix lines; no substantive derivation was shortened to a representative summary.
- Public TeX hygiene: no workflow artifact paths, review-status headings, claim/hypothesis/invariant environments, placeholder title, malformed bare citation/reference commands, or duplicate labels.
- Compilation: attempted with `tectonic`; the installed binary terminated before TeX processing because its macOS system-configuration networking thread panicked (`Attempted to create a NULL object`).  Static delimiter, environment-balance, label/reference, and citation checks passed, but a PDF/log compilation result is unavailable in this environment.

## Output Hashes

- `1_intro.tex`: `1c7d2fea42cd38621222c3d2af6e4ddf1ce0e112d1b6d82d9952f2aa94534292`
- `2_preliminary.tex`: `07efc3676204bd713ad79d73c9fb9787aff5a54a5658c501432cf70733a01df4`
- `3_main.tex`: `5d24edfcef37e94bdb5b97a52cc16f1a179608382d893f4f1eee47486c9f7c0f`
- `4_proof_sketch.tex`: `b8235c018a47c1e0528a540ebc54a59c64f503129e667b121962ee22ee017279`
- `5_appendix.tex`: `005247ae3f28b5171beaa66aa23b2d41f2fe21e898729678c7d5384ec76b8c03`
