...
- Repair-trigger aggregate review SHA-256: `f3693ae4e7ee8f0d9db97130f506cab38545b502840bf09d923cde3cf9306cbd`
...
- Appendix source-length diagnostic: 4,327 source lines under local derivation/target assembly versus 4,967 appendix lines; no substantive derivation was shortened to a representative summary.
- Bundle line counts (`1_intro`, `2_preliminary`, `3_main`, `4_proof_sketch`, `5_appendix`, `main`): 168, 123, 160, 35, 4,967, and 25.
...
- Compilation: the attempt-3 `tectonic` retry again terminated before TeX processing because its macOS system-configuration networking thread panicked (`Attempted to create a NULL object`) and produced no PDF or log. Static delimiter, environment-balance, label/reference, and citation checks passed, but a compilation result is unavailable in this environment.

## Output Hashes

- `1_intro.tex`: `d81c181c5325fa8c4acb258d7f6c102a419d2cc7cf86f093ed7a831814987a9a`
- `2_preliminary.tex`: `0a894f0494b93f9afaa565d484ba1b5451b4e191152f84020ebb0e9a7bbf53e3`
- `3_main.tex`: `fcb96a9f6f2b8e6c4a1469f2bb838b0a3fe97a9c1be9ee350ae9c800e9ea52f6`
- `4_proof_sketch.tex`: `b8235c018a47c1e0528a540ebc54a59c64f503129e667b121962ee22ee017279`
- `5_appendix.tex`: `df8d8d7980ad4968120b73bd6b49638874fb4d09d4f3eecc95a3eba24e696d01`
