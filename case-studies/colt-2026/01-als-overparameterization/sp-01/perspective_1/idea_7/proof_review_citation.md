...
1. The available `tectonic` binary still fails before TeX processing, so no
   ...
   final attempt-5 bundle find 87 unique labels, no duplicate labels, no
   unresolved recognized `\ref` or `\pageref` target, and no missing BibTeX
   key.

2. `latex_template/5_appendix.tex:3369` and line 3395 retain the descriptive
   phrase `Step~009`, and line 4402 retains the local display locator `(A2)`.
...
- Cited theorem statements: This review is bound to final attempt-5
  `assembly_report.md` SHA-256
  `6df30193da02586c00006fa93f24a0900e89d1642421f70c6d060327821070b1`.
  The accepted setting, sketch/sketch-review, and global diagnostic/review
  ...
  and `80ef3512062b3830473c9e8b50e72365af34c4295b0246624e41a8871b98b5a0` /
  ...
  for `5_appendix.tex`,
  `5ff5df773bead89ced16a22e8992684af8b74138f2336cb05cfd13127f1e0e60`
  for `main.tex`,
  `e1d28a2426c8595fb5b68f444cda16893f6bc646e031a8a89f9b59c33f0bdb42`
  for `arxiv.sty`, and
...
- Appendix cited-result traceability: The former Step 010 cycle is removed.
  ...
  consumer.  The Step 002 public target-window and competitor/event displays
  now carry the accepted `(21)` and `(22)` tags, and the later local assembly
  cites those tags together with the unchanged `(32)` event identity.  The
  restored five-row finite-range certificate is also identical to the
  accepted source.  Other cross-step uses name earlier Lemmas or Propositions
  and restate the consumed interfaces in current notation.
