...
Under \(E_{\rm sm},E_{\rm cert\_eq},E_{\rm cluster},E_{\rm gauge}\), for every
...
The off-diagonal mass satisfies
\[
...
\[
 F(1/32)<0
\]
(the left part is below \(0.0041\), whereas \(1/32=0.03125\)), the two
...
On the accepted selected-state interfaces, simultaneously for all modes,
\[
