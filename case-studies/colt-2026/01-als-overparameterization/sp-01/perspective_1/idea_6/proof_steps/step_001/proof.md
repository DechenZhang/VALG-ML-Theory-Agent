...
- The accepted sketch-9 `global_proof.md` was read only together with its
  accepted `global_proof_review.md` (respective SHA-256 values
  `a4d5f9953eedd3eced7248328b79839083bbda8a9c246b506a018d529d8f7ffd` and
...
- No archived artifact or prior sketch-attempt proof/review was used as
  mathematical evidence.  The proof above was freshly revalidated against
  the same unchanged step claim and five primitive setting assumptions under
  accepted sketch attempt 9 (binding sketch SHA-256
