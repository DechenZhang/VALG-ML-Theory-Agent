...
Prove that the observable selected initialization, after the proof-only
target permutation and product-preserving sign orientation, is within
C_best=512 times omega=q_*^2+r tau_r of the realized CP target in the
relative-amplitude quotient norm and in relative Frobenius norm. The proof
must expose the exact target-projector decomposition, the represented-product
register, the four scalar/linear/quadratic/cubic residual classes, the target
norm lower bound, and the cancellation of kappa_0.
...
- Accepted E_sm supplies unit realized columns, Gram row/column
  off-diagonal mass at most q_*, Gamma<=1.01, and positive realized
  weights. Its producer is
  Proposition~\ref{prop:step-001-smoothed-event};
  frozen proof/review hashes:
  d8a566c9d56d59699fc65dcc5cd79db0cea9ed2a73df7d703b2bc17aa25f407c
  and c4e9cd72ff31b4cbd021aa2f1674ccfa19dbf8cf070e6c46545558dd8ab50750.
- Accepted E_gauge from Lemma~\ref{lem:step-005-gauge} supplies the proof-only
  ...
  initialization term. Frozen step-005 proof/review hashes:
  e6ed7fde93e2f31d0907174c9c1bca93260ba902da11681474dce0deb2e257e9
  and c1011300ce700063a58c2b8143e945f1fe9710183b650ffb7a22f4b4f2612ce5.
- Accepted Propositions~\ref{prop:step-006-column-root} and
  ...
  \(\max_j\|N_M(:,j)\|_2\le\tau_r\). Frozen step-006 proof/review hashes:
  eb0be9d68f9e5c38a995fe27d1cb228316753ce0d8c597d607061dd4b03d42f5
  and 35d8e18e47b025dbbdc61a611a2bc364b063e2ff89586151a74ab1ec6719abb8.
...
The accepted step-006 propositions state (1) for
\[
...
\[
 a_j={\bar\theta_j\over\lambda_j},\qquad
 \alpha_j=a_j^{1/3}-1,\qquad
...
**Proof.**
By (11), \(|a_j-1|\le64\omega<1/2\). The elementary inequalities
\[
...
perpendicular fields for step_007b; it does not project the algorithmic
...
Put \(d_{M,j}:=\bar p_{M,j}-g_{M,j}\) and \(\beta_j:=a_j-1\). Then
\[
...
\[
 |\beta_j|\le64\omega,\qquad |a_j|\le1+64\omega.         \tag{25}
\]
...
\[
 \|A\operatorname{diag}(\lambda a)\|_F
...
\]
The target claim, including the 48 omega interface consumed by step_007b,
is complete.
...
- \(H_M,L_M,B_M,C_M,N_M,Q_M\) are exact realized target-projector objects.
  ...
  D_M^\perp,a_j,\alpha_j,\beta_j\) are proof-local.
