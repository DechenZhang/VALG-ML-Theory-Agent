...
- The accepted `global_proof.md` was read only together with its accepted
  `global_proof_review.md` (respective SHA-256 prefixes `cc284000` and
  `2f203ae4`).  Its step-relevant diagnostic suggestion was to split linear,
...
- Sketch-attempt-1 step proofs and reviews were not used as evidence.  This
  is a fresh proof under accepted sketch attempt 2.
