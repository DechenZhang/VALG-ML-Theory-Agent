...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Scale-aware smoothing bridge, rare-extreme proposal coverage, cyclic ratio contraction, observable clustering, local-basin transfer, and active CP-ALS refinement | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Exact cyclic contamination recurrence is false at an allowed interior orthogonal equal-weight entry; preserving the setting and goal requires an idea-level procedure, entry-certificate, or recurrence change. |
