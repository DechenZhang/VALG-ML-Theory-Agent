...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Public block-triple residual transactions, scale-local isolation/decrease gate, and full-space balanced PL | sketch | sketch | 1 |  | N/A |  |  | Fresh idea after idea-13 IDEA_FAIL; preserve exact objective/rank/endpoint/probability/baseline while changing the activation/certificate protocol to public low-dimensional block transactions. |
