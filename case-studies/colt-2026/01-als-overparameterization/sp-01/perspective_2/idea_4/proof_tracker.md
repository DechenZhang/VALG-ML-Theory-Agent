...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Smoothed near-orthogonal geometry, sequential certified probes, norm-purity/span transfer, trust-region reserve, and protected PL refinement | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Exact beta at the empty protected state is the full weight vector, contradicting one-target purity; full balanced radial curvature rejects informative small probes. Repair requires a changed certificate/output/procedure or theorem contract. |
