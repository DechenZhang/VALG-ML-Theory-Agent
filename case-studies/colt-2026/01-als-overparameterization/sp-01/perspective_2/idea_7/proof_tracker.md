...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Static Gram kernels, lifted statewise Neumann ledger with accepted-history closure, full-space certificate transactions, all-commit amplification, and same-target terminal PL refinement | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Tested-mode history charge omits the diagonal identity and falsifies R-update at the first accepted certificate. |
