...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Smoothed near-orthogonal geometry, transactional radial brackets, angular certificate/isolation, rollback reserve, and protected terminal PL refinement | sketch | sketch | 1 | Fail | N/A | REVISE_SKETCH | /proof-sketch | Prior beta/radial blockers are repaired; weighted isolation, certificate-to-invariant scale, span accumulation, projected angular update, and polynomial Haar-basin interfaces need same-setting repair. |
| 2 | Weighted angular isolation and scale-matched invariant, accumulated span bridge, explicit projected updates, and quantitative Haar-basin reachability | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Exact projected-complement commits force orthogonal directions, creating an Omega(kappa nu) mismatch with allowed nonorthogonal targets and preventing any required PL chart entry; weighted leakage also grows as kappa^6 mu^2. Requires changed projection/procedure or theorem contract. |
