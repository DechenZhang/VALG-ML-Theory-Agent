...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Full-space transactional radial/angular discovery, separation-gated label induction, structured accepted-error ledger, and same-target unprojected terminal PL refinement | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Allowed three-label correlation chain falsifies pair-local Led-2 at the first certificate; upstream ledger contract must change. |
