...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Base KR near-isometry to realized margin, random-feature coverage, channel growth and leakage closure, landscape/PL bridge, and relative-error convergence | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Sketch score 2; allowed dormant normalized state has zero gradient, PSD Hessian, no cubic escape, and only sixth-order descent; retry mode new_idea |
