...
- Current idea: `perspective_2/idea_12`, sketch attempt 3 (revise_sketch).
...
The live proof sketch is now attempt 3 (revise_sketch). The selected
candidate-relative framework is unchanged; the concise seven-row repair folds
the transaction/resolvent, transition/induction, and terminal-rate bookkeeping
boundaries while retaining their local units and gate evidence. The archived
attempt-2 survey remains history only.
