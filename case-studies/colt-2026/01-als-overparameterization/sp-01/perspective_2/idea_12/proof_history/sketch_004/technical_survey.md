...
- Current idea: `perspective_2/idea_12`, sketch attempt 4 (revise_sketch).
...
The live proof sketch is now attempt 4 (revise_sketch). The selected
candidate-relative framework and seven-row graph are unchanged. This repair
adds typed LP lower/upper preservation, the public Raw-J-rel substitution,
certificate-scale seed margins and guarded path bounds, and the
threshold-linked U3 dominance discharge. The archived attempt-3 survey
