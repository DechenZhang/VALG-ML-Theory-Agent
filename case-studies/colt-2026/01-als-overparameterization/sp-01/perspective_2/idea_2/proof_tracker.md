...
| -------------- | --------------- | --------- | ------- | ------------ | ---------------------- |:-----:| -------------- | ------------ | ------- |
| 1 | Good-instance conditioning, tape anti-concentration and homogeneous growth, reset-budgeted promotion and persistence, reachable-chart entry, protected PL refinement, and explicit rate aggregation | sketch | sketch | 1 | Fail | N/A | IDEA_FAIL | /subagent-idea-generator | Equality-only probationary cap parking yields geometrically vanishing feasible dyadic steps on a reachable positive-growth path; universal inverse-polynomial step lower bound is impossible. |
