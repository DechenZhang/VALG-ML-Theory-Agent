...
space. The auxiliary assump:rank-regime source is used only for k>=r when
...
Under assump:base-column-conditioning, assump:base-product-balance,
assump:gaussian-smoothing, assump:dimension-regime, assump:smoothing-scale,
assump:modewise-gram-margin, Assumption~\ref{assump:rank-regime} for `k>=r`,
and the conclusion of Lemma \ref{lem:p2-i9-s6-step001-normalization}, the
centered matrices
...
Under assump:base-column-conditioning, assump:base-product-balance,
assump:gaussian-smoothing, assump:dimension-regime, assump:smoothing-scale,
assump:modewise-gram-margin, the perturbation event E_str of Lemma
