...
equation \eqref{eq:step-009-7} give
\begin{equation}
\begin{aligned}
...
and equation \eqref{eq:step-009-9} inherits the conditional \(r^{-20}\) failure bound
...
Gram, size, and deficit events. Combining equations \eqref{eq:step-010-1}--\eqref{eq:step-010-2} with the
