...
degree-one empty-tuple convention. Combining their conclusions pointwise,
for every \(y\in G_0\), gives
\[
 Q^0_y((E^0_{I_0})_y)
 \leq \widehat K_0(y)\lambda(s_0(I_0;y))
 \leq \widehat K_0(y)B_0(d,R)\lvert I_0\rvert.
\]
The rightmost function of \(y\) is measurable because \(\widehat K_0\) is
measurable and \(B_0(d,R)\lvert I_0\rvert\) is a fixed finite scalar. Thus
integrating only this measurable majorant in (15) yields
\[
\begin{aligned}
 \mu(H_{d,I_0})
 &\leq\int_{G_0}\widehat K_0(y)B_0(d,R)\lvert I_0\rvert
       \,\nu_0(dy)\\
 &= B_0(d,R)\lvert I_0\rvert
...
\(\widehat K_\infty(y)\) is finite and dominates the outer kernel. Combining
this domination with (20) pointwise, for every \(y\in G_\infty\), gives
\[
 Q^\infty_y((E^\infty_{I_+})_y)
 \leq \widehat K_\infty(y)\lambda(s_\infty(I_+;y))
 \leq \widehat K_\infty(y)B_\infty(d,R)\lvert I_+\rvert.
\]
The rightmost function is measurable because \(\widehat K_\infty\) is
measurable and \(B_\infty(d,R)\lvert I_+\rvert\) is a fixed finite scalar.
Therefore, integrating only this measurable majorant in (19),
\[
\begin{aligned}
 \mu(H_{d,I_+})
 &\leq\int_{G_\infty}\widehat K_\infty(y)B_\infty(d,R)\lvert I_+\rvert
       \,\nu_\infty(dy)\\
 &= B_\infty(d,R)\lvert I_+\rvert
...
outer cap is finite on \(G_\infty\), so combining its Borel-set domination
with (24) pointwise, for every \(y\in G_\infty\), gives
\[
 Q^\infty_y((E^\infty_{I_-})_y)
 \leq \widehat K_\infty(y)\lambda(s_\infty(I_-;y))
 \leq \widehat K_\infty(y)B_\infty(d,R)\lvert I_-\rvert.
...
The rightmost function is measurable because \(\widehat K_\infty\) is
measurable and \(B_\infty(d,R)\lvert I_-\rvert\) is a fixed finite scalar.
Thus integrating only this measurable majorant in (23) and then applying the
outer mean inequality gives
\[
\begin{aligned}
 \mu(H_{d,I_-})
 &\leq\int_{G_\infty}\widehat K_\infty(y)B_\infty(d,R)\lvert I_-\rvert
...
- Boundary check: Empty and singleton pieces have probability zero; arbitrary
  ...
  finite-cap full-measure sets; only the measurable cap times the corresponding
  fixed scalar \(B_i(d,R)\lvert I_\bullet\rvert\) is integrated; and \(d=1\)
  uses one common unconditional kernel with two separately applied primitive
  mean inequalities.
