...
- Accepted dependency proof/review artifacts:
  - `perspective_2/idea_1/proof_steps/step_005/proof.md`, SHA-256
    ...
    sketch attempt 1, step_005, unit attempt 2, with `Step Proof Status =
    COMPLETE`.
  - `perspective_2/idea_1/proof_steps/step_005/review.md`, SHA-256
    ...
    reviewed proof hash `648d8636744627fa0ce80997a499324d4eae25b6f88e330449833068628e9030`.
...
- Global diagnostic boundary: `global_proof.md` was not read or used in this
  unit attempt. No global diagnostic statement serves as proof evidence, a
  cited result, an assumption source, or authority to alter the accepted
  target, dependencies, or scope.
