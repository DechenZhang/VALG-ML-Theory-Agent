...
$\gamma_i\ll\nu_i\otimes\lambda$.  The Radon--Nikodym theorem
...
finite measures \cite[Lemma~1.1]{Kallenberg2002} extends this identity to every Borel $B$ on one full-measure
...
inequality, by absolute continuity of the integral of the $L^1$ density
\cite[Proposition~2.23]{Folland1999} and convergence of interval lengths.  Thus
$\widehat K_i(y)>a$.  Letting
...
measurable rectangles.  The $\pi$--$\lambda$ theorem
\cite[Lemma~1.1]{Kallenberg2002} proves the assertion
...
convergence \cite[Theorem~2.14]{Folland1999}.  A second $\pi$--$\lambda$
argument \cite[Lemma~1.1]{Kallenberg2002} gives, for every Borel
$E\subseteq\R\times S$,
\begin{equation}
