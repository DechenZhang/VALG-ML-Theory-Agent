...
- Accepted dependency proof/review artifacts:
  ...
  - `proof_steps/step_003/proof.md`, SHA-256
    `826572f09a2165fa971ed4c47a7e2863744d42c8dea30b63fb2b5ee0db4791f8`,
    paired with unit-attempt-1 `proof_steps/step_003/review.md`, SHA-256
    `8ec90c3b97a70b28b347f3182aa0edde20aa1ac184ea3696b3f8ea5215be1395`,
    whose status is ACCEPTED and whose reviewed proof hash is the preceding
    proof hash.
...
- Global diagnostic boundary: `global_proof.md`, SHA-256
  ...
  whose status is ACCEPTED. Its step_004 diagnostic suggested organizing the
  calculation by matching kernels and finite-cap full-measure sets. Every
  mathematical statement used here is independently supplied by the setting,
  accepted dependency results, or the three local derivations. The global
...
- Dependency check: The proof and review hashes recorded above match the
  accepted unit-attempt-1 identities for steps step_001, step_002, and
  step_003.
